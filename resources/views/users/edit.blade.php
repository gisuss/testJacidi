                    ...
                    <form method="POST" action="{{ route('update.user', ['id' => $user->id]) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="role" id="role" class="form-control @error('role') is-invalid @enderror" value="{{ $user->role }}" required>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <a class="btn btn-primary" href="{{ route('index.user') }}"><i class="fa-solid fa-angles-left"></i> Regresar</a>
